...
class DSA815: 
    def __init__(self):
        ...
        self.read_termination = '/n'
        self._spectrum = None # Open the first available resource and fix this
        
    def connect(self, address):
        """Connect to the spectrum analyzer"""
        self._spectrum = self.rm.open_resource(address)
        self._spectrum.read_termination = '\n'
    ...
    def get_freq_points(self): 
        ...
        points = self._spectrum.query(":SENSe:SWEep:POINts?") # FIX? DK - crashed
        return int(points)
